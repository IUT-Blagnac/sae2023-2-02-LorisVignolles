...
| 2    | link:src/simplicite-meilleur.c           | C        | Simplicité | Meilleur
| 3    | link:src/SimplicitePire.java             | Java     | Simplicite | Pire
| 4    | link:src/EfficacitePire.java             | Java     | Efficacité | Pire
| 5    | link:src/EfficacitePire2.java            | Java     | Efficacité | Pire
| 6    | link:src/EfficaciteMeilleur.java         | Java     | Efficacité | Meilleur
| 7    | link:src/SobrieteMeilleur.java           | Java     | Sobriete   | Meilleur
| 8    | link:src/SobrietePire.java               | Java     | Sobriete   | Pire
|====================================================================================
