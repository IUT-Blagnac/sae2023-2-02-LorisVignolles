...
public class EfficaciteMeilleur {
	...
	public static List<String> solution(String str, List <Character> ordre) {
		...
		//pour chaque lettre de l'ordre, on cherche les mots qui commençent par cette lettre et on les ajoute a une nouvelle arrayList
		...
		// À la fin, les mots non triés sont ajoutés sans ordre
